...
-- RENK VE ESTETİK
(gen_random_uuid(), 'Sevdiğim renk ve estetik anlayışım', 'En sevdiğim renk mavidir. Estetik konusunda çok hassasım, şık ve sade şeyler hoşuma gider. Vision board yapmayı seviyorum, görsel estetik benim için çok önemli. Modern, minimalist ama sıcak bir tarz tercih ederim.', 'profile_renk', 'kişisel', 'tr', false, 1, true, now(), now()),

-- DETAYLI YEMEK TERCİHLERİ
(gen_random_uuid(), 'Detaylı yemek tercihlerim', 'En sevdiğim yemekler: sushi (kendim yapıyorum), tiramisu, napolyon pastası, sosyete mantısı, mantar mezesi, Sezar salata, balzamik soslu salata, dana eti yemekleri, zeytinyağlılar, Çerkes tavuğu, avokadolu yemekler, şawarma (gerçek versiyonu). Azerbaycan mutfağından: yarpaq xıngal, levengi, qazmaq, vişneli sarma. 30 kilo kışlık domates sosu yaptım, turşularımı kendim kuruyorum. Pastacılık: pandispanya, cheesecake, cinnabon, tiramisu yapıyorum, profesyonel miksörüm var.', 'profile_yemek_detay', 'yemek', 'tr', false, 1, true, now(), now());
